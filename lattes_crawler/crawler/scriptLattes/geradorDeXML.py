...
class GeradorDeXML:
	...
	def gerarXmlParaGrupo(self, save = True):
		...
		xmlTemp += self.getTextoResumo(registro)
	...
	def getTextoResumo(self, registro):
		xmlTemp = ''
		if registro.textoResumo:
			xmlTemp += '    <texto_resumo>\n'
			xmlTemp += '        <texto>' + registro.textoResumo + '</texto>\n'
			xmlTemp += '    </texto_resumo>\n'
		return xmlTemp
